        ...
        <ItemTemplate>			
		    ...
		    <div class="card-content text-center">
		        <div class="stack-group description">		            
					<asp:Panel runat="server" ID="description" Text="<%#: Item.HotelDescription %>"><%#: Item.HotelDescription %></asp:Panel>                                                                      
				</div>  
			    <asp:LinkButton ID="ApproveHotelRequest" CssClass="col-md-6" runat="server" Visible="true">
				    <h5 runat="server" class="btn btn-info">Approve hotel request</h5>
			    </asp:LinkButton>
			    <asp:HyperLink ID="DenyHotelRequest" CssClass="" runat="server" Visible="true"
				     NavigateUrl='<%# $"../DenyHotelRequest.aspx?id={Item.Id}" %>'>
				    <h5 runat="server" class="btn btn-danger">Deny hotel request</h5>
			    </asp:HyperLink>
		    </div>
        </ItemTemplate>
    </asp:ListView>
