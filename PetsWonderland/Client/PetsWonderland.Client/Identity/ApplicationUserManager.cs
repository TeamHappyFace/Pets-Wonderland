...
namespace PetsWonderland.Client.Identity
{
	...
	public class ApplicationUserManager : UserManager<UserProfile>
	{
		...
		public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
		{
			...
			userManager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<UserProfile>
			{
				MessageFormat = "Your security code is {0}"
			});
			userManager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<UserProfile>
			{
